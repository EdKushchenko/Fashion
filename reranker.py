...
# Constants
DATASET_PATH = "🔵real_outfits.parquet"  # Update this to your actual file path
...
# Main Interface with hardcoded dataset
if not st.session_state.outfits_loaded:
    try:
        # Load data from hardcoded path
        outfits, features = load_outfit_data(DATASET_PATH)
